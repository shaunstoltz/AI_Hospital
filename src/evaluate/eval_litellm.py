...
class Evaluator:
    ...
    def build_dialog_platform(self):
        ...
        self.doctor_name_to_diagnosis = {}
        for doctor_name, doctor_diagnosis_filepath in [
                ("mix22b", "../outputs/dialog_history_iiyi/dialog_history_any_mix22b_p26_EN.jsonl"),
                ("llama370b", "../outputs/dialog_history_iiyi/dialog_history_any_llama370b_p26_EN.jsonl"),            
